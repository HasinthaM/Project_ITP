    ...
    <div>
      ...
      <div className='eventsSet'>
        <div className='events'>
          ...
          <Link to='/eventform/Event001'><button className='bookButton'>Booking</button></Link>
        </div>
        ...
        <div className='events'>
          ...
          <Link to='/eventform/Event002'><button className='bookButton'>Booking</button></Link>
        </div>
        ...
        <div className='events'>
          ...
          <Link to='/eventform/Event003'><button className='bookButton'>Booking</button></Link>
        </div>
        ...
        <div className='events'>
          ...
          <Link to='/eventform/Event004'><button className='bookButton'>Booking</button></Link>
        </div>
        ...
        <div className='events'>
          ...
          <Link to='/eventform/Event005'><button className='bookButton'>Booking</button></Link>
        </div>
        ...
        <div className='events'>
          ...
          <Link to='/eventform/Event006'><button className='bookButton'>Booking</button></Link>
        </div>
      </div>
