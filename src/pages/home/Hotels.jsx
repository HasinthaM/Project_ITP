    ...
    <div>
      ...
      <div className='hotelsSet'>
        <div className='hotels'>
          ...
          <Link to='/hotelform/Room001'><button className='bookButton'>Booking</button></Link>
        </div>
        ...
        <div className='hotels'>
          ...
          <Link to='/hotelform/Room002'><button className='bookButton'>Booking</button></Link>
        </div>
        ...
        <div className='hotels'>
          ...
          <Link to='/hotelform/Room003'><button className='bookButton'>Booking</button></Link>
        </div>
      </div>
